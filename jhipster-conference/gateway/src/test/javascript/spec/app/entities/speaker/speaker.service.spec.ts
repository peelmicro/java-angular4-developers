    ...
    describe('Speaker Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/speakers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Speaker', () => {
                service.create(new Speaker(null)).subscribe(received => {
            ...
            it('should update a Speaker', () => {
                service.update(new Speaker(123)).subscribe(received => {
